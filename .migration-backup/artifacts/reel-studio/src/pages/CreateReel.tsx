...
import {
  ...
  Upload, X, Type, Hash, AlignLeft, Music, Zap, Clock, Star,
} from "lucide-react";
...
export default function CreateReel() {
  ...
  }, [quote, author, category, activeTemplate, activeFont, brandName, logoUrl, customBg, audioUrl, audioVolume, transition, duration, quality, toast]);
              ...
              <div className="relative z-10 flex flex-col items-center text-center w-full gap-5 h-full justify-center">
                ...
                <p className="leading-relaxed"
                  style={{
                    ...
                    fontFamily: activeFont.family,
                    fontSize: quote.length > 100 ? "0.85rem" : quote.length > 60 ? "1rem" : "1.15rem",
